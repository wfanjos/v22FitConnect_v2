...
App de treinos de musculação que conecta aluno e professor. Faz parte da marca V22, com logo e mascote baseados na harpia (gavião-real).

## Conteúdo

| Pasta/arquivo | O que tem |
|---|---|
| [`docs/planejamento-app.md`](docs/planejamento-app.md) | Decisões de produto e stack do app |
...
| `Claude outputs/sheet.png` | Prévia de todas as versões do logo em fundo claro e escuro |

## Stack prevista

React Native (Expo) · Supabase · SQLite offline · painel admin em React + Vite
